...
Это очень долго с точки зрения времени выполнения. И правда — для массива из n элементов нам нужно сделать
n! (факториал) перестановок и проверить каждую из них. Помните, в начале модуля мы говорили про алгоритмы
сложности O(n!)? Сейчас (в первый и в последний раз) мы с вами реализуем такой алгоритм.
"""
